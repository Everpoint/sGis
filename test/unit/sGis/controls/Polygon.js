    ...
    describe('sGis.controls.Polygon', function () {
        ...
        describe('initialization', function() {
            it('should be initialized with only map parameter', function() {
                ...
                expect(control instanceof sGis.controls.Polygon).toBe(true);
            });

            it('should throw an exception if no valid map is provided', function() {
                expect(function() { var control = new sGis.controls.Polygon(); }).toThrow();
                expect(function() { var control = new sGis.controls.Polygon('map'); }).toThrow();
                expect(function() { var control = new sGis.controls.Polygon(123); }).toThrow();
                expect(function() { var control = new sGis.controls.Polygon([map]); }).toThrow();
                expect(function() { var control = new sGis.controls.Polygon({}); }).toThrow();
            });
        });
        ...
        describe('properties', function() {
            var control;
            beforeEach(function() {
                control = new sGis.controls.Polygon(map);
            });
            ...
            describe('.activeLayer', function() {
                ...
                it('should be set in constructor', function() {
                    var control1 = new sGis.controls.Polygon(map, {activeLayer: layer});
