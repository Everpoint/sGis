...
$(function() {
    ...
    describe('sGis.controls.Distance', function () {
        ...
        describe('initialization', function() {
            it('should be initialized with only map parameter', function() {
                var control = new sGis.controls.Distance(map);
                expect(control instanceof sGis.controls.Distance).toBe(true);
            });

            it('should throw an exception if no valid map is provided', function() {
                expect(function() { var control = new sGis.controls.Distance(); }).toThrow();
                expect(function() { var control = new sGis.controls.Distance('map'); }).toThrow();
                expect(function() { var control = new sGis.controls.Distance(123); }).toThrow();
                expect(function() { var control = new sGis.controls.Distance([map]); }).toThrow();
                expect(function() { var control = new sGis.controls.Distance({}); }).toThrow();
            });
        });
        ...
        describe('properties', function() {
            var control;
            beforeEach(function() {
                control = new sGis.controls.Distance(map);
            });
            ...
            describe('.activeLayer', function() {
                ...
                it('should be set in constructor', function() {
                    var control1 = new sGis.controls.Distance(map, {activeLayer: layer});
