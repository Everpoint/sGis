...
$(function() {
    ...
    describe('sGis.controls.Area', function () {
        ...
        describe('initialization', function() {
            it('should be initialized with only map parameter', function() {
                var control = new sGis.controls.Area(map);
                expect(control instanceof sGis.controls.Area).toBe(true);
            });

            it('should throw an exception if no valid map is provided', function() {
                expect(function() { var control = new sGis.controls.Area(); }).toThrow();
                expect(function() { var control = new sGis.controls.Area('map'); }).toThrow();
                expect(function() { var control = new sGis.controls.Area(123); }).toThrow();
                expect(function() { var control = new sGis.controls.Area([map]); }).toThrow();
                expect(function() { var control = new sGis.controls.Area({}); }).toThrow();
            });
        });
        ...
        describe('properties', function() {
            var control;
            beforeEach(function() {
                control = new sGis.controls.Area(map);
            });
            ...
            describe('.activeLayer', function() {
                ...
                it('should be set in constructor', function() {
                    var control1 = new sGis.controls.Area(map, {activeLayer: layer});
