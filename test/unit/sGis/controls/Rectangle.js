...
$(function() {
    ...
    describe('sGis.controls.Rectangle', function () {
        ...
        describe('initialization', function() {
            it('should be initialized with only map parameter', function() {
                var control = new sGis.controls.Rectangle(map);
                expect(control instanceof sGis.controls.Rectangle).toBe(true);
            });

            it('should throw an exception if no valid map is provided', function() {
                expect(function() { var control = new sGis.controls.Rectangle(); }).toThrow();
                expect(function() { var control = new sGis.controls.Rectangle('map'); }).toThrow();
                expect(function() { var control = new sGis.controls.Rectangle(123); }).toThrow();
                expect(function() { var control = new sGis.controls.Rectangle([map]); }).toThrow();
                expect(function() { var control = new sGis.controls.Rectangle({}); }).toThrow();
            });
        });
        ...
        describe('properties', function() {
            var control;
            beforeEach(function() {
                control = new sGis.controls.Rectangle(map);
            });
            ...
            describe('.activeLayer', function() {
                ...
                it('should be set in constructor', function() {
                    var control1 = new sGis.controls.Rectangle(map, {activeLayer: layer});
