...
$(function() {
    ...
    describe('sGis.controls.Polyline', function () {
        ...
        describe('initialization', function() {
            it('should be initialized with only map parameter', function() {
                ...
                expect(control instanceof sGis.controls.Polyline).toBe(true);
            });

            it('should throw an exception if no valid map is provided', function() {
                expect(function() { var control = new sGis.controls.Polyline(); }).toThrow();
                expect(function() { var control = new sGis.controls.Polyline('map'); }).toThrow();
                expect(function() { var control = new sGis.controls.Polyline(123); }).toThrow();
                expect(function() { var control = new sGis.controls.Polyline([map]); }).toThrow();
                expect(function() { var control = new sGis.controls.Polyline({}); }).toThrow();
            });
        });
        ...
        describe('properties', function() {
            var control;
            beforeEach(function() {
                control = new sGis.controls.Polyline(map);
            });
            ...
            describe('.activeLayer', function() {
                ...
                it('should be set in constructor', function() {
                    var control1 = new sGis.controls.Polyline(map, {activeLayer: layer});
