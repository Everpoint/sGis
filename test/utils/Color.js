describe('sGis.utils.Color',() =>{
 ...
 describe('setHsv', () =>{
     it('should correctly parse hsv color into rgb', () => {
         expect(new sGis.utils.Color('#fdbcae').setHsv(120, 60, 30)).toEqual([31, 77, 31]);
         expect(new sGis.utils.Color('#fdbcae').setHsv(360, 0, 100)).toEqual([255, 255, 255]);
         expect(new sGis.utils.Color('#fdbcae').setHsv(15, 25, 45)).toEqual([115, 93, 86]);
     });
