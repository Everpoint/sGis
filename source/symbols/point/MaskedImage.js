sGis.module('symbol.point.MaskedImage', [
    ...
    class MaskedImage extends Symbol {
        ...
        _updateMasked() {
            ...
            this._maskedSrc = resultCanvas.getImageData(0, 0, this._image.width, this._image.height);
        }
        
        _recolorMask(imageData) {
            var maskColor = new Color(this._maskColor);
     ...
     * @default 32
     */
    MaskedImage.prototype.height = 10;
     ...
     * @default {x: 16, y: 16}
     */
    MaskedImage.prototype.anchorPoint = {x: 16, y: 16};
    ...
    MaskedImage.prototype._maskColor = 'rgba(155, 219, 0, 0)';
    
    symbolSerializer.registerSymbol(MaskedImage, 'point.Image', ['width', 'height', 'anchorPoint', 'imageSource', 'maskSource', 'maskColor']);
