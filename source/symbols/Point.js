sGis.module('symbol.point', [
    ...
    pointSymbols.Point.prototype = new sGis.Symbol({
        _fillColor: 'black',
        ...
        clone: function() {
            return new pointSymbols.Point({size: this.size, fillColor: this.fillColor, strokeWidth: this.strokeWidth, strokeColor: this.strokeColor, offset: this.offset});
        },
    ...
    sGis.utils.proto.setProperties(pointSymbols.Point.prototype, {
        type: {default: 'point', set: null},
        size: 10
    });

    Object.defineProperties(pointSymbols.Point.prototype, {
        fillColor: {
            get: function() {
    ...
    pointSymbols.Image.prototype = new sGis.Symbol({
    ...
    Object.defineProperties(pointSymbols.Image.prototype, {
        type: {
            value: 'point'
        },
    ...
    pointSymbols.Square.prototype = new sGis.Symbol({
        _size: 10,
        _strokeWidth: 2,
        _strokeColor: 'black',
        ...
        clone: function() {
            return new pointSymbols.Square({size: this.size, fillColor: this.fillColor, strokeWidth: this.strokeWidth, strokeColor: this.strokeColor, offset: this.offset});
        },
    ...
    Object.defineProperties(pointSymbols.Square.prototype, {
        type: {
            value: 'point'
        },
    ...
    pointSymbols.MaskedImage.prototype = new sGis.Symbol({
        _size: 34,
        ...
        clone: function() {
            return new pointSymbols.MaskedImage({size: this.size, anchorPoint: this.anchorPoint, renderToCanvas: this.renderToCanvas, imageSource: this.imageSource, maskSource: this.maskSource, maskColor: this.maskColor});
        },
    ...
    Object.defineProperties(pointSymbols.MaskedImage.prototype, {
        type: {
            value: 'point'
        },
